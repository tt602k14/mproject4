...
public class WorkoutDetailActivity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        ...
        btnStartWorkout.setOnClickListener(v -> {
            // Check if this is a premium workout
            boolean isPremiumWorkout = isPremiumCategory(workoutCategory);
            
            if (isPremiumWorkout && !PremiumManager.isPremiumUser(this)) {
                PremiumManager.showPremiumDialog(this, "Bài tập " + workoutCategory);
                return;
            }
    ...
    private boolean isPremiumCategory(String category) {
        // Define which categories require premium
        return category.equals("advanced") || category.equals("professional") || 
               category.equals("expert") || category.equals("premium");
    }
    ...
    private void loadChestExercises() {
        ...
        addExerciseSet("Hít đất rộng", "3 x 12 lần", "Đặt tay rộng hơn vai", "https://youtu.be/5Qv2T8VusME");
        ...
        addExerciseSet("Chống đẩy ngực", "3 x 10 lần", "Dùng ghế hoặc xà kép", "https://youtu.be/2z8JmcrW-As");
        addExerciseSet("Ép ngực", "3 x 15 lần", "Ép hai tay vào nhau trước ngực", "https://youtu.be/Qb9l36NDAhw");
        addExerciseSet("Dumbbell Fly", "3 x 12 lần", "Nằm ngửa, mở rộng tay ra hai bên", "https://youtu.be/eozdVDA78K0");
        addExerciseSet("Incline Push-Up", "3 x 15 lần", "Tay đặt lên bề mặt cao, tập ngực trên", "https://youtu.be/DbFgADa2PL8");
        addExerciseSet("Hít đất Archer", "3 x 8 lần/bên", "Một tay duỗi thẳng, một tay chống", "https://youtu.be/J0DnG1_S92I");
        addExerciseSet("🧘 Giãn cơ ngực", "2 x 30 giây", "Duỗi tay ra sau, mở rộng ngực", "https://youtu.be/eozdVDA78K0");
    }
    ...
    private void loadShoulderExercises() {
        ...
        addExerciseSet("Chạm vai", "3 x 20 lần", "Plank và chạm tay vào vai đối diện", "https://youtu.be/1We3zKXj_uA");
        addExerciseSet("Vòng tay", "3 x 30 giây", "Xoay tay theo vòng tròn", "https://youtu.be/5Qv2T8VusME");
        addExerciseSet("Nâng tay ngang", "3 x 15 lần", "Nâng tay ra hai bên đến ngang vai", "https://youtu.be/3VcKaXpzqRo");
        addExerciseSet("Nâng tay trước", "3 x 15 lần", "Nâng tay lên phía trước", "https://youtu.be/qM5X-_FfCQE");
        addExerciseSet("Đẩy vai", "4 x 12 lần", "Đẩy tạ hoặc chai nước lên trên đầu", "https://youtu.be/qEwKCR5JCog");
        addExerciseSet("Arnold Press", "3 x 12 lần", "Xoay tay khi đẩy tạ lên", "https://youtu.be/6Z15_WdXmVw");
        addExerciseSet("Rear Delt Fly", "3 x 15 lần", "Nâng tay ra sau để tập vai sau", "https://youtu.be/EA7u4Q_8HQ0");
        addExerciseSet("Upright Row", "3 x 12 lần", "Kéo tạ lên dọc theo thân người", "https://youtu.be/um3LNkMEFMg");
        addExerciseSet("Face Pull", "3 x 15 lần", "Kéo dây về phía mặt, mở rộng vai", "https://youtu.be/rep-qVOkqgk");
        addExerciseSet("🧘 Giãn cơ vai", "2 x 30 giây", "Kéo tay qua ngực giãn vai sau", "https://youtu.be/aKNn76T3RPE");
    }
    ...
    private void loadLegsExercises() {
        ...
        addExerciseSet("Ngồi tường", "3 x 45 giây", "Tựa lưng vào tường, ngồi 90 độ", "https://youtu.be/y-wV4Venusw");
        addExerciseSet("Nâng bắp chân", "4 x 20 lần", "Đứng trên mũi chân", "https://youtu.be/gwLzBJYoWlI");
        addExerciseSet("Chùng chân ngang", "3 x 12 lần/chân", "Bước sang bên và hạ người", "https://youtu.be/8pl4hWllMPQ");
        addExerciseSet("Gánh đùi Bulgaria", "3 x 12 lần/chân", "Một chân lên ghế, chân kia squat", "https://youtu.be/2C-uStzPJWY");
        addExerciseSet("Nâng mông", "4 x 15 lần", "Nằm ngửa, nâng hông lên cao", "https://youtu.be/wPM8icPu6H8");
        addExerciseSet("Bước lên bậc", "3 x 15 lần/chân", "Bước lên ghế hoặc bậc thang", "https://youtu.be/ultWZbUMPL8");
        addExerciseSet("Sumo Squat", "3 x 15 lần", "Đứng rộng, mũi chân xoay ra ngoài", "https://youtu.be/WsepIUGZu0c");
        addExerciseSet("Leg Curl nằm", "3 x 12 lần", "Nằm sấp, co chân về phía mông", "https://youtu.be/1Tq3QdYUuHs");
        addExerciseSet("🧘 Giãn cơ chân", "2 x 30 giây", "Giãn tứ đầu và gân kheo", "https://youtu.be/gwLzBJYoWlI");
    }
    ...
    private void loadAbsExercises() {
        ...
        addExerciseSet("Gập bụng xe đạp", "3 x 20 lần", "Nằm ngửa, đạp chân như đạp xe", "https://youtu.be/9FGilxCbdz8");
        addExerciseSet("Nâng chân", "3 x 15 lần", "Nằm ngửa, nâng chân lên cao", "https://youtu.be/JB2oyawG9KI");
        addExerciseSet("Xoay người Nga", "3 x 30 lần", "Ngồi, xoay thân sang hai bên", "https://youtu.be/wkD8rjkodUI");
        addExerciseSet("Leo núi", "3 x 30 giây", "Tư thế plank, kéo đầu gối lên ngực", "https://youtu.be/nmwgirgXLYM");
        addExerciseSet("Plank nghiêng", "2 x 45 giây/bên", "Plank nghiêng sang một bên", "https://youtu.be/K2VljzCC16g");
        addExerciseSet("Đá chân nhanh", "3 x 30 giây", "Nằm ngửa, đá chân lên xuống", "https://youtu.be/ANVdMDaYRts");
        addExerciseSet("V-Up", "3 x 12 lần", "Nằm ngửa, nâng tay chân lên cùng lúc", "https://youtu.be/7UVgs18Y1P4");
        addExerciseSet("Ab Wheel Rollout", "3 x 10 lần", "Lăn bánh xe về phía trước", "https://youtu.be/LlDNef_Ztsc");
        addExerciseSet("Hanging Knee Raise", "3 x 15 lần", "Treo xà, co đầu gối lên ngực", "https://youtu.be/JB2oyawG9KI");
        addExerciseSet("🧘 Giãn cơ bụng", "2 x 30 giây", "Cobra stretch, ưỡn lưng giãn bụng", "https://youtu.be/JnHnd4SNKR8");
    }
    ...
    private void loadBackExercises() {
        ...
        addExerciseSet("Thiên thần ngược", "3 x 12 lần", "Nằm sấp, vẫy tay như thiên thần", "https://youtu.be/HSoHeSjvIdY");
        addExerciseSet("Nâng tay chữ Y", "3 x 12 lần", "Nằm sấp, nâng tay tạo hình chữ Y", "https://youtu.be/aKNn76T3RPE");
        addExerciseSet("Nâng tay chữ T", "3 x 12 lần", "Nằm sấp, nâng tay tạo hình chữ T", "https://youtu.be/T3b5yJNhjhQ");
        addExerciseSet("Chó chim", "3 x 12 lần/bên", "Quỳ, duỗi tay chân đối diện", "https://youtu.be/wiFNA3sqjCA");
        addExerciseSet("Mèo - Bò", "3 x 15 lần", "Quỳ, uốn cong và võng lưng", "https://youtu.be/kqnua4rHVVA");
        addExerciseSet("Dumbbell Row", "3 x 10 lần/bên", "Chống tay lên ghế, kéo tạ lên", "https://youtu.be/pYcpY20QaE8");
        addExerciseSet("Inverted Row", "3 x 12 lần", "Nằm dưới xà, kéo người lên", "https://youtu.be/G8l_8chR5BE");
        addExerciseSet("Good Morning", "3 x 12 lần", "Cúi người về phía trước, giữ lưng thẳng", "https://youtu.be/YA-h3n9L4YU");
        addExerciseSet("🧘 Giãn cơ lưng", "2 x 30 giây", "Child's pose, giãn toàn bộ lưng", "https://youtu.be/eqVMAPM00GM");
    }
    ...
    private void loadAllExercises() {
        ...
        addExerciseSet("Chạy tại chỗ", "3 x 30 giây", "Nâng cao đùi", "https://youtu.be/8opcQdC-V-U");
