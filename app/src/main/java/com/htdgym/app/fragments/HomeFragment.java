...
public class HomeFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        imgFeatured.setOnClickListener(v -> {
            String videoUrl = currentTab.equals("build_muscle") 
                    ? "https://youtu.be/YTOGoC2HEf8" // Full body muscle building workout
                    : "https://youtu.be/GU5_SdDdc8o"; // Fat burning HIIT workout
    ...
    private void setupTabs() {
        ...
        YouTubeThumbnailHelper.loadThumbnail(this, imgFeatured, "https://youtu.be/YTOGoC2HEf8");
    }
    ...
    private void switchTab(String tab) {
        ...
        if (tab.equals("build_muscle")) {
            ...
            YouTubeThumbnailHelper.loadThumbnail(this, imgFeatured, "https://youtu.be/GU5_SdDdc8o");
    ...
    private void addProgramCard(String title, String subtitle, String startDay, String endDay, String startDayVideoUrl, String endDayVideoUrl, String cardImageUrl) {
        ...
        YouTubeThumbnailHelper.loadThumbnail(this, cardImage, cardImageUrl);
    ...
    private void addProgramItem(String title, String videoUrl, String programType) {
        ...
        YouTubeThumbnailHelper.loadThumbnail(this, thumbnail, videoUrl);
